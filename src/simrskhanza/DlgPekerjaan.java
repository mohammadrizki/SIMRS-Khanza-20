 ...
 * @author dosen
 */
public class DlgPekerjaan extends javax.swing.JDialog {
    ...
    /** Creates new form DlgPekerjaan
     * @param parent
     * @param modal */
    public DlgPekerjaan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tbpekerjaan.setModel(tabMode);
        //tampil();
        //tbJabatan.setDefaultRenderer(Object.class, new WarnaTable(Scroll.getBackground(),Color.GREEN));
        tbpekerjaan.setPreferredScrollableViewportSize(new Dimension(500,500));
        tbpekerjaan.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    private void initComponents() {
        ...
        tbpekerjaan.setAutoCreateRowSorter(true);
        tbpekerjaan.setName("tbpekerjaan"); // NOI18N
        tbpekerjaan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbpekerjaanMouseClicked(evt);
            }
        });
        tbpekerjaan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbpekerjaanKeyPressed(evt);
            }
        });
        Scroll.setViewportView(tbpekerjaan);
    ...
    private void tbpekerjaanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbpekerjaanMouseClicked
...
}//GEN-LAST:event_tbpekerjaanMouseClicked

    private void tbpekerjaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbpekerjaanKeyPressed
        if(tabMode.getRowCount()!=0){
...
}//GEN-LAST:event_tbpekerjaanKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPekerjaan dialog = new DlgPekerjaan(new javax.swing.JFrame(), true);
    ...
    private widget.Table tbpekerjaan;
