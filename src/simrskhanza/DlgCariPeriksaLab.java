...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLabPDF1 = new javax.swing.JMenuItem();
        MnCetakHasilLabPDF2 = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLabKualiKuantiEn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabKualiKuantiEnActionPerformed(evt);
            }
        });
        ...
        MnCetakHasilLabPDF1.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabPDF1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLabPDF1.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLabPDF1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLabPDF1.setText("Kuanti & Kuali ID");
        MnCetakHasilLabPDF1.setName("MnCetakHasilLabPDF1"); // NOI18N
        MnCetakHasilLabPDF1.setPreferredSize(new java.awt.Dimension(100, 26));
        MnCetakHasilLabPDF1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabPDF1ActionPerformed(evt);
            }
        });
        MnPDFLab.add(MnCetakHasilLabPDF1);

        MnCetakHasilLabPDF2.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabPDF2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCetakHasilLabPDF2.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLabPDF2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLabPDF2.setText("Kuanti & Kuali EN");
        MnCetakHasilLabPDF2.setName("MnCetakHasilLabPDF2"); // NOI18N
        MnCetakHasilLabPDF2.setPreferredSize(new java.awt.Dimension(125, 26));
        MnCetakHasilLabPDF2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabPDF2ActionPerformed(evt);
            }
        });
        MnPDFLab.add(MnCetakHasilLabPDF2);
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if(tabMode.getRowCount()==0){
                    ...
                    Valid.MyReport("rptPeriksaLabPermintaan_1.jasper","report","::[ Data Pemeriksaan Laboratorium ]::",param);
                }   break;
            case 1:
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilLabKualiKuantiIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabKualiKuantiIdActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabKualiKuantiIdActionPerformed

    private void MnCetakHasilLabDeskripEnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabDeskripEnActionPerformed
        // TODO add your handling code here:
...
//            param.put("tb",Sequel.cariIsi("select tinggi from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
    ...
    private void MnCetakHasilLabKualiKuantiEnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabKualiKuantiEnActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
    ...
    }//GEN-LAST:event_MnCetakHasilLabKualiKuantiEnActionPerformed

    private void MnCetakHasilLabPDF1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabPDF1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReportPDF("rptPeriksaLabPermintaan1.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{                              
                                Valid.MyReportPDF("rptPeriksaLabPermintaan_1.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabPDF1ActionPerformed

    private void MnCetakHasilLabPDF2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabPDF2ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            TCari.requestFocus();
                    ...
                    while(rs.next()){
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                param.put("tanggalpermintaan",rspermintaan.getString("tgl_permintaan"));  
                                param.put("jampermintaan",rspermintaan.getString("jam_permintaan"));
                                Valid.MyReportPDF("rptHasilLabNumerik_EN1.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{                              
                                Valid.MyReportPDF("rptHasilLabNumerik_EN.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : "+e);
                        } finally{
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabPDF2ActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilLabDeskripEn;
    private javax.swing.JMenuItem MnCetakHasilLabDeskripId;
    private javax.swing.JMenuItem MnCetakHasilLabKualiKuantiEn;
    private javax.swing.JMenuItem MnCetakHasilLabKualiKuantiId;
    private javax.swing.JMenuItem MnCetakHasilLabPDF1;
    private javax.swing.JMenuItem MnCetakHasilLabPDF2;
